        ...
        <section className="w-screen 2xl:h-200 lg:min-h-160 min-h-120 bg-primary grid grid-cols-2 place-items-center 2xl:place-items-start 2xl:py-12 2xl:px-32 md:px-12 px-5 md:gap-8 gap-3">
          ...
          <div className="col-span-2 md:col-span-1 gap-6 2xl:pt-27 text-background">
            ...
            <article className="text-body 2xl:pe-32 mt-8">
              ...
              menyatukan tradisi, alam, dan budaya Bali sejak 2010.
            </article>
          </div>
        </section>
        <section className="w-screen 2xl:min-h-200 lg:min-h-screen min-h-120 bg-background grid grid-cols-1 text-center py-12 lg:px-32 md:px-12 px-5">
          <div className="col-span-1">
            ...
            <article className="text-body 2xl:px-80 lg:px-44 md:px-32 mt-8">
              ...
              lahan pertanian dan tegalan, sementara sebagian lainnya bergerak
              di sektor pariwisata, kerajinan, dan usaha berbasis masyarakat.
              Kehidupan desa berjalan harmonis dengan alam dan adat istiadat
              yang tetap terjaga.
              <br />
              <br />
        ...
        <section className="w-screen lg:min-h-180 min-h-120 bg-primary text-background grid grid-cols-2 justify-items-center lg:items-start items-center py-12 lg:px-32 md:px-12 px-5">
          <div className="col-span-2 md:col-span-1 gap-6 lg:pt-8 ">
            ...
            <article className="text-body lg:pe-12 mt-8">
              ...
              keluar dari kesengsaraan. Dinamika sejarahnya berakar dari Pura
              Ulun Tegal, temuan arkeologis Pura Batu Megong, hingga pemugaran
              berkala yang memperkuat identitas spiritual dan budaya desa hingga
              kini.
            </article>
          </div>
