...
export default function Home() {
  return (
    <main className="min-w-screen min-h-screen">
      <section className="bg-background px-32 py-20 grid place-items-center grid-cols-2 items-start lg:pt-36">
        <div className="col-span-1">
          <h1 className="text-heading1 font-extrabold text-primary">
            DESA KARANG DALEM TUA
          </h1>
          <p className="text-body font-light">
            Karang Dalem Tua – Harmoni Tradisi, Alam, dan Kehidupan
          </p>
          <button className="mt-8 bg-primary text-background w-44 h-16 rounded-tl-[28px] rounded-tr-0 rounded-br-[28px] rounded-bl-0 flex items-center justify-center gap-1">
            <p>Jelajahi</p>
            <svg
        ...
        <div className="col-span-1 flex gap-12">
          <figure className="relative lg:w-87.25 lg:h-122.25 ">
            <Image
              src={Image1}
              alt="Home Image"
              fill
          ...
          <figure className="relative w-87.25 h-186">
            <Image
              src={Image1}
              alt="Home Image"
              fill
              className="object-cover rounded-tl-[80px] rounded-tr-0 rounded-br-[80px] rounded-bl-0"
            />
          </figure>
        </div>
      </section>
      <section className="text-background w-screen lg:h-261.75 px-32 bg-primary grid grid-cols-2 items-center">
        <div className="lg:col-span-1 h-full flex items-center">
          <figure className="relative lg:w-155.5 lg:h-155.5">
            <Image
              src={Image1}
            ...
            />
            <figure className="absolute lg:w-89.25 lg:h-89.25 lg:-bottom-20 lg:-right-20">
              <Image
                src={Image1}
                alt="About Section Image"
                fill
        ...
        <div className="lg:col-span-1 h-full">
          <h2 className="text-background font-extrabold lg:mt-56">
            Mengenal Desa Adat Karang Dalem Tua
          </h2>
          <article className="text-body lg:mt-6">
          ...
          <button className="lg:mt-20  bg-accent text-primary w-44 h-16 rounded-tl-[28px] rounded-tr-0 rounded-br-[28px] rounded-bl-0 flex items-center justify-center gap-1">
            <p>Jelajahi</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
      ...
      <section className="w-screen lg:min-h-261.75 py-20 bg-background">
        <h2 className="text-primary text-center font-extrabold lg:mt-20 ">
          APA YANG KAMI KERJAKAN
        </h2>
        <p className="text-body text-center">
          Ragam Kegiatan yang Kami Jaga dan Kembangkan
        </p>
        <div className="w-screen flex justify-center flex-wrap gap-44 lg:mt-32">
          {projects.map((p, index) => (
            <div className="">
              <figure className="relative lg:w-87.25 lg:h-99.5">
                <Image
                  src={p.image}
                  alt={p.title}
                  fill
              ...
              <p className="text-body text-center underline text-sky-500 mt-8">
                {p.title}
              </p>
            </div>
          ))}
      ...
      <section className="w-screen lg:h-261.75 grid grid-cols-2">
        <figure className="col-span-1 relative w-full h-full">
          ...
          <div className="z-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <h2 className="text-background text-center">Penjor Galungan</h2>
            <button className="lg:mt-20 mx-auto bg-transparent border-2 border-background text-background w-44 h-16 rounded-tl-[28px] rounded-tr-0 rounded-br-[28px] rounded-bl-0 flex items-center justify-center gap-1">
              <p>Jelajahi</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 640"
      ...
      <section className="w-screen lg:h-261.75 grid grid-cols-2 lg:px-12 justify-items-center items-center">
        <h2 className="lg:mt-12 text-center col-span-2">
          SEKILAS PESONA ALAM KAMI
        </h2>
        <div className="col-span-1 ">
          <figure className="relative grid grid-cols-3 lg:w-156.75 lg:h-470,25 gap-3">
            {views.map((v, index) => (
              <Image
                key={index}
                src={v}
                ...
                width={100}
                height={100}
                className="object-cover w-52 h-52 col-span-1 rounded-4xl"
              />
            ))}
          </figure>
        </div>
        <div className="col-span-1 lg:pe-32">
      ...
      <section className="w-screen lg:h-170 lg:px-32 lg:py-12">
        <figure
          className="w-full h-full relative bg-no-repeat bg-center bg-cover bg-fixed"
          style={{ backgroundImage: `url(${Image1.src})` }}
        >
          <div className="absolute inset-0 bg-black/40 z-0" />
          <div className="absolute text-background z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <h2 className="text-center font-extrabold">
              Ingin Tau Lebih Lanjut?
            </h2>
            <article className="text-center text-body">
            ...
            <div className="flex gap-10 justify-center ">
              <button className="group relative lg:mt-8 bg-transparent border-2 border-background text-background w-44 h-16 rounded-tl-[28px] rounded-tr-0 rounded-br-[28px] rounded-bl-0 flex items-center justify-center gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="w-4"
              ...
              <button className="group cursor-pointer relative lg:mt-8 bg-transparent border-2 border-background text-background w-44 h-16 rounded-tl-[28px] rounded-tr-0 rounded-br-[28px] rounded-bl-0 flex items-center justify-center gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="w-4"
